...
def add_update_tab():
    selected_date = st.date_input("Enter Date", datetime(2024,8,1), label_visibility = "collapsed", key = "selected_date") # we gave default value
    ...
    with st.form(key = "expense_form"):
        ...
        for i in range(5):
            ...
            with col1:
                ...
                #step is used to define by how much the value would be increased if the add button there is pressed
            with col2:
        ...
        if submit_button:
            ...
            if response.status_code == 200:
                st.success("Expenses validated successfully")
            else:
